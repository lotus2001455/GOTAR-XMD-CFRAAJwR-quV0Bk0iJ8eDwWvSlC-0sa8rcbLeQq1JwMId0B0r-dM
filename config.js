...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "GOTAR~XMD~CFRAAJwR#quV0Bk0iJ8eDwWvSlC-0sa8rcbLeQq1JwMId0B0r-dM ",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*ROI-SEBA☠️A L'INSTANT👻*",
...
BOT_NAME: process.env.BOT_NAME || "ROI-SEBA",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "ROI-SEBA",
...
OWNER_NAME: process.env.OWNER_NAME || "ROI-SEBA",
// add bot owner name
